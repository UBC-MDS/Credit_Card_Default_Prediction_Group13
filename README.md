...
or Mac:
```
docker run --rm --platform linux/amd64-v "$PWD:/home/Credit_Card_Default_Prediction_Group13" chesteraigo/mds_522_credit_card_group_13 make -C '/home/Credit_Card_Default_Prediction_Group13' all
```
